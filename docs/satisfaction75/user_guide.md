...
![](../images/initial_flash/via_custom_menu.jpg)

From there, you can control the enabled encoder modes and default OLED mode:

![](../images/initial_flash/via_encoder_modes.jpg)
![](../images/initial_flash/via_oled.jpg)

To set a custom encoder behavior, you can use this chart:
![](../images/initial_flash/via_custom_encoder.jpg)
